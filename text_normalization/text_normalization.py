#Bu Proje FIRAT KAAN BİTMEZ tarafından hazırlanmıştır.
#Projede Amacımız 9 farklı normalizasyon tekniklerini öğrenerek bir text normalization uygulaması yazmaktır.
...
#Noktalama işaretlerinin kaldırılması, metinden özel karakterleri ve noktalama işaretlerini kaldırma
...
#Durak kelime kaldırma, “the” ve “a” gibi anlamı çok az olan yaygın kelimelerin kaldırılmasıdır.
...
# 5) Lemmatization
#Lemmatizasyon, “koşuyor” kelimesini “koş” olarak kök haline getirirken kelimenin kullanıldığı bağlamı
...
#Belirteçleme, metni bireysel kelimeler veya ifadeler olarak ayırmak anlamına gelir
...
#Bu teknik, metin verilerinde HTML etiketleri, URL'ler ve e-posta adresleri gibi metin dışı unsurları
